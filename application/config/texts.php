...
return array(
    ...
    "FEEDBACK_PASSWORD_WRONG_3_TIMES" => "El inicio de sesión falló 3 o más veces. Por favor, espere 30 segundos para volver a intentarlo.",
    "FEEDBACK_ACCOUNT_NOT_ACTIVATED_YET" => "Your account is not activated yet. Please click on the confirm link in the mail.",
    "FEEDBACK_USERNAME_OR_PASSWORD_WRONG" => "El correo o la contraseña son incorrectas, intente nuevamente.",
    "FEEDBACK_USER_DOES_NOT_EXIST" => "This user does not exist.",
    "FEEDBACK_LOGIN_FAILED" => "Login failed.",
    "FEEDBACK_LOGIN_FAILED_3_TIMES" => "El inicio de sesión falló 3 o más veces. Por favor, espere 30 segundos para volver a intentarlo.",
